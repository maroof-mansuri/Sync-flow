...
static DataOutputStream dop;
    ServerChat(){
        ...
        p1.add(l3);
         ...
         p1.add(l4);
          ...
          JLabel name=new JLabel("Abhay Gupta");
    ...
    public static void main(String args[]) throws Exception{
        ServerChat c1=new ServerChat();

        ServerSocket ss1=new ServerSocket(4444);
    while(true){
        Socket s1=ss1.accept();
        DataInputStream dip=new DataInputStream(s1.getInputStream());
        dop=new DataOutputStream(s1.getOutputStream());
        String str1="",str2="";
